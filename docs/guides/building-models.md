...
- **Implement a Model**: See [Building Workers](building-workers.md) to create a Worker that satisfies a Model contract.
- **Build an Adapter**: See [Building Adapters](building-adapters.md) for format translation.
- **Compose a Manager**: See [Building Managers](building-managers.md) to orchestrate an application.
