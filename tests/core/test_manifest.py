...
def test_valid_manifest():
    ...
    path = os.path.join(os.path.dirname(__file__), "dummy_workers", "valid", "worker.yaml")
...
def test_invalid_manifest():
    loader = ManifestLoader()
    path = os.path.join(os.path.dirname(__file__), "dummy_workers", "invalid_schema", "worker.yaml")
